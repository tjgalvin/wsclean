...
class ImageFilename {
 public:
  ...
  std::string GetBeamPrefix(const WSCleanSettings& settings) const {
    return GetBeamPrefix(settings, _polarization, _channelIndex, _intervalIndex,
                         _isImaginary);
  }
  ...
  static std::string GetPSFPrefix(const WSCleanSettings& settings,
  ...
  static std::string GetPrefix(const WSCleanSettings& settings,
  ...
  static std::string GetBeamPrefix(const WSCleanSettings& settings,
                                   aocommon::PolarizationEnum polarization,
                                   size_t channelIndex, size_t intervalIndex,
                                   bool isImaginary) {
    std::ostringstream partPrefixNameStr;
  ...
  static std::string GetMFSPrefix(const WSCleanSettings& settings,
                                  aocommon::PolarizationEnum polarization,
