...
class LBeamEvaluator {
 public:
  ...
  void Evaluate(double ra, double dec, double frequency, size_t antennaIndex,
                aocommon::MC2x2& beamValues);

  void Evaluate(const PrecalcPosInfo& posInfo, double frequency,
                size_t antennaIndex, aocommon::MC2x2& beamValues);

  void EvaluateFullArray(const PrecalcPosInfo& posInfo, double frequency,
                         aocommon::MC2x2& beamValues);
  ...
  static void EvaluateFullCorrection(casacore::MeasurementSet& ms, double ra,
                                     double dec, const aocommon::BandData& band,
                                     aocommon::MC2x2* beamValues);
 ...
 private:
  ...
  void dirToITRF(const casacore::MDirection& dir,
                 LOFAR::StationResponse::vector3r_t& itrf) {
...
inline void LBeamEvaluator::Evaluate(double, double, double, size_t,
                                     aocommon::MC2x2&) {
  throw std::runtime_error(
      "LBeamEvaluator::Evaluate() was called, but the LOFAR beam library was "
      "not available/specified during compilation");
}

inline void LBeamEvaluator::Evaluate(const PrecalcPosInfo&, double, size_t,
                                     aocommon::MC2x2&) {
  throw std::runtime_error(
      "LBeamEvaluator::Evaluate() was called, but the LOFAR beam library was "
      "not available/specified during compilation");
...
inline void LBeamEvaluator::EvaluateFullArray(const PrecalcPosInfo&, double,
                                              aocommon::MC2x2&) {
  throw std::runtime_error(
      "LBeamEvaluator::Evaluate() was called, but the LOFAR beam library was "
      "not available/specified during compilation");
...
inline void LBeamEvaluator::PrecalculatePositionInfo(PrecalcPosInfo&, double,
                                                     double) {}

inline void LBeamEvaluator::SetTime(const casacore::MEpoch& time) {
  _time = time;
}

inline void LBeamEvaluator::EvaluateFullCorrection(casacore::MeasurementSet&,
                                                   double, double,
                                                   const aocommon::BandData&,
                                                   aocommon::MC2x2*) {
  throw std::runtime_error(
      "LBeamEvaluator::Evaluate() was called, but the LOFAR beam library was "
      "not available/specified during compilation");
