...
public:
	...
	static void SelectStructures(const IUWTDecomposition& iuwt, IUWTMask& mask, const aocommon::UVector<double>& thresholds, size_t minScale, size_t endScale, double cleanBorder, const bool* priorMask, size_t& areaSize);
	...
	static void Floodfill(const IUWTDecomposition& iuwt, IUWTMask& mask, const aocommon::UVector<double>& thresholds, size_t minScale, size_t endScale, const Component& component, double cleanBorder, size_t& areaSize);
	
	static void MaskedFloodfill(const IUWTDecomposition& iuwt, IUWTMask& mask, const aocommon::UVector<double>& thresholds, size_t minScale, size_t endScale, const Component& component, double cleanBorder, const bool* priorMask, size_t& areaSize);
