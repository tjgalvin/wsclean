...
int main(int argc, char* argv[])
{
	if(argc <= 1)
	{
		std::cout << "Syntax: testgenerichogbom [-no-clark] <freqcount> <niter> {<image> <psf>} [..]\n";
		return -1;
	}
	...
	clean.ExecuteMajorIteration(dirtySet, modelSet, psfVec, width, height, reachedMajorThreshold);
