...
int main(int argc, char* argv[]) {
  ...
  // Not strictly required, but the following line will turn on FFTW
  // multi-threading. In this particular scenario, without w-term correction,
  // this speeds up the FFT a bit.
  FFTWManager fftwMT;
  ...
  WStackingGridder gridder(width, height, pixelScale, pixelScale, threadCount,
                           &allocator, 15, 201);
  ...
  // gridded area:
  double u = 100.0,  // These are in units of number of wavelengths
      v = 10.0, w = 10.0;
